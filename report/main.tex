...
\hline
\texttt{AuthSecurityIntegrationTest} & Logowanie JWT, profil bieżącego użytkownika, ochrona endpointów tokenem Bearer i blokada panelu administracyjnego dla roli autora. \\
\hline
...
Wynik testów backendu: 6 testów, 0 błędów i 0 niepowodzeń. Zestaw obejmuje test uruchomienia kontekstu aplikacji, testy workflow zgłoszeń i administracji, a także testy bezpieczeństwa dla logowania JWT, endpointu bieżącego użytkownika, dostępu bez tokena Bearer oraz blokady panelu administracyjnego dla roli \texttt{AUTHOR}. Build frontendu oraz lint zakończyły się poprawnie. Dokumentacja obrazkowa została wygenerowana z działającego środowiska Docker, co zwiększa wiarygodność zrzutów ekranu.
